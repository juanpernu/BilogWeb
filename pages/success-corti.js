...
const SuccessCasesCorti = () => {
  const { title, bgImg, section: { first, second, third = null } } = content['corti'];
  return (
    <Layout>
      <section className="success-container">
        ...
        <p className="success-container--text cta">Somos más que un software para la administración del consultorio, te ayudamos
        a llevar tu negocio al siguiente nivel. <a href="/contact">¡Contactanos!</a></p>
      </section>
      <style jsx>
        {`
          {/* STYLES FOR MOBILE */}
...
export default SuccessCasesCorti;
