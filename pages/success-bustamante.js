...
const SuccessCasesBustamante = () => {
  const { title, bgImg, section: { first, second, third = null } } = content['bustamante'];
  return (
    <Layout>
      <section className="success-container">
        ...
        <p className="success-container--text cta">Si queres saber cómo podemos ayudarte a mejorar los procesos operativos de tu consultorio o centro, <a href="/contact">contactanos</a>.</p>
      </section>
      <style jsx>
        {`
      {/* STYLES FOR MOBILE */}
...
export default SuccessCasesBustamante;
