const documents = {
    ...
    features: [
      ...
      },
      {
        ...
        featureContent:[{
          title: "Pacientes",
          copy: "La mejor SoluciónTecnológica para las tareas administrativas de su consultorio. Información Integrada.",
      ...
      },
      {
        hash:"#audit-module",
        featureContent:{
          title: "Auditoria (No disponible en Versión Small). Mucho mas es lo que se puede perder cuando no hay auditoria. Una heramienta eficaz para evitar perdidas de dinero.",
          copy: "Ventajas y Beneficios",
      ...
      },
      {
        ...
        {
          title: "Esta liquidación cumple con los requerimientos de la S.O.L.P.",
          copy: false,
          text: false,
          image:'laimagen.png',
          video: false,
